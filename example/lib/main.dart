...
void main() {
  AppRoutes.configureRoutes({
    'pageA': AppRoutesHandler(handlerFunc: (_, __) {
      return PageA();
    }),
    'pageB': AppRoutesHandler(handlerFunc: (_, __) {
      return PageB();
    })
  });
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      navigatorObservers: [APPRouteObserver.defaultObserver],
    );
  }
}
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  void _incrementCounter() {
    AppNavigator.push(context, 'pageA');
  }
